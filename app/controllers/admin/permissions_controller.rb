class Admin::PermissionsController < AdminController
  ...
  def create
    ...
    respond_to do |format|
      if @permission.save
        format.html { redirect_to admin_permissions_url, notice: 'Permission was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @permission.update_attributes(params[:permission])
        format.html { redirect_to admin_permissions_url, notice: 'Permission was successfully updated.' }
